...
class AdropRewardedAdAdModule: RCTEventEmitter, AdropRewardedAdDelegate {
    ...
    private func sendAdEvent(unitId: String, requestId: String, method: String, errorCode: String? = nil) {
    ...
    func onAdReceived(_ ad: AdropRewardedAd) {
        sendAdEvent(unitId: ad.unitId, requestId: self.requestIdFor(ad), method: AdropMethod.DID_RECEIVE_AD)
    }
